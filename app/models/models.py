...
class LaserPar(Base):
    ...
    laser_program = Column(Integer)
    ramp_length = Column(Float)
    ramp_type = Column(String)
    laser_power = Column(Float)
    puls_duration = Column(Float)
    fiber_diameter = Column(Float)
    sheet_1_height = Column(Float)
    sheet_1_material = Column(String)
    sheet_2_height = Column(Float)
    sheet_2_material = Column(String)
    sheet_3_height = Column(Float)
    sheet_3_material = Column(String)
    gap_1 = Column(Float)
    gap_2 = Column(Float)
